...
export class CreateTables1753692857022 implements MigrationInterface {
    name = 'CreateTables1753692857022'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "slots" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "start_time" TIME NOT NULL, "end_time" TIME NOT NULL, "is_booked" boolean NOT NULL DEFAULT false, "avg_consult_time" integer NOT NULL DEFAULT '10', "max_bookings" integer NOT NULL DEFAULT '1', "session_id" uuid, "doctorId" uuid, CONSTRAINT "PK_8b553bb1941663b63fd38405e42" PRIMARY KEY ("id"))`);
