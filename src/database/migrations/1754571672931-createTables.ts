...
export class CreateTables1754571672931 implements MigrationInterface {
    name = 'CreateTables1754571672931'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."recurring_day" AS ENUM('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY')`);
        await queryRunner.query(`CREATE TABLE "recurring_sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "day" "public"."recurring_day" NOT NULL, "consult_start_time" TIME NOT NULL, "consult_end_time" TIME NOT NULL, "booking_start_time" TIME NOT NULL, "booking_end_time" TIME NOT NULL, "avg_consult_time" integer NOT NULL DEFAULT '10', "is_active" boolean NOT NULL DEFAULT true, "doctor_id" uuid, CONSTRAINT "PK_0a38105d4f373732116bf8aa159" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."session_day" AS ENUM('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY')`);
        await queryRunner.query(`CREATE TABLE "sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "session_date" date NOT NULL, "day" "public"."session_day" NOT NULL, "consult_start_time" TIME NOT NULL, "consult_end_time" TIME NOT NULL, "booking_start_time" TIME NOT NULL, "booking_end_time" TIME NOT NULL, "avg_consult_time" integer NOT NULL DEFAULT '10', "is_active" boolean NOT NULL DEFAULT true, "doctor_id" uuid, "recurringTemplateId" uuid, CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_eff5fcaebe7779b892f07e9215e" FOREIGN KEY ("recurringTemplateId") REFERENCES "recurring_sessions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_eff5fcaebe7779b892f07e9215e"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."recurring_day"`);
